...
import LinearEquationSolver from '../../components/interactive/LinearEquationSolver';
...
<h3 id="interactive" style="margin-top:2rem;">💻 5. Công cụ giải phương trình tương tác</h3>

<p>Thử nghiệm giải phương trình dạng $ax + b = cx + d$ từng bước:</p>

<LinearEquationSolver client:load />

<h3 id="dac-biet" style="margin-top:2rem;">⚠️ 6. Các trường hợp đặc biệt</h3>
