...
const PROBLEMS: Problem[] = [
  {
    id: 1,
    prompt: 'Hàm số bậc nhất y = ax + b đồng biến trên R khi nào?',
    latexExpression: 'y = ax + b \\quad (a = ?)',
    options: ['a > 0', 'a < 0', 'a = 0', 'b > 0'],
    correctIndex: 0,
    solution: 'Hàm số bậc nhất y = ax + b đồng biến trên R khi và chỉ khi hệ số a > 0.',
  },
  {
    id: 2,
    prompt: 'Hàm số bậc nhất y = ax + b nghịch biến trên R khi nào?',
    latexExpression: 'y = ax + b \\quad (a = ?)',
    options: ['a < 0', 'a > 0', 'b < 0', 'a = 0'],
    correctIndex: 0,
    solution: 'Hàm số bậc nhất y = ax + b nghịch biến trên R khi và chỉ khi hệ số a < 0.',
  },
  {
    id: 3,
    prompt: 'Giao điểm của đồ thị hàm số y = 2x - 4 với trục tung Oy có tọa độ là:',
    latexExpression: 'x = 0 \\Rightarrow y = ?',
    options: ['(0; -4)', '(-4; 0)', '(0; 2)', '(2; 0)'],
    correctIndex: 0,
    solution: 'Giao điểm với Oy: Cho x = 0 \\Rightarrow y = -4 \\Rightarrow Tọa độ là (0; -4).',
  },
  {
    id: 4,
    prompt: 'Giao điểm của đồ thị hàm số y = 2x - 4 với trục hoành Ox có tọa độ là:',
    latexExpression: 'y = 0 \\Rightarrow 2x - 4 = 0 \\Rightarrow x = ?',
    options: ['(2; 0)', '(0; 2)', '(-4; 0)', '(0; -4)'],
    correctIndex: 0,
    solution: 'Giao điểm với Ox: Cho y = 0 \\Rightarrow 2x - 4 = 0 \\Rightarrow x = 2 \\Rightarrow Tọa độ là (2; 0).',
  },
  {
    id: 5,
    prompt: 'Đồ thị của hàm số bậc nhất y = ax + b (a ≠ 0) là một đường thẳng:',
    latexExpression: '\\text{Đồ thị hàm số bậc nhất}',
    options: ['Cắt trục tung tại điểm (0; b) và cắt trục hoành tại (-b/a; 0)', 'Luôn đi qua gốc tọa độ O(0; 0)', 'Là đường cong parabol', 'Là đường thẳng song song với trục tung'],
    correctIndex: 0,
    solution: 'Đồ thị hàm số y = ax + b (a khác 0) là đường thẳng cắt Oy tại (0; b) và Ox tại (-b/a; 0).',
  },
];

export default function HamSoBacNhatInteractive() {
  ...
  return (
    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', margin: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h4 style={{ margin: 0, color: '#1e293b', fontSize: '1.15rem' }}>🎯 Luyện tập Hàm số bậc nhất & Đồ thị đường thẳng</h4>
