...
const PROBLEMS: Problem[] = [
  {
    id: 1,
    prompt: 'Rút gọn phân thức \\dfrac{2x^2 - 4x}{x - 2} được kết quả:',
    latexExpression: '\\dfrac{2x(x - 2)}{x - 2} = ?',
    options: ['2x', 'x - 2', '2', 'x'],
    correctIndex: 0,
    solution: '\\dfrac{2x^2 - 4x}{x - 2} = \\dfrac{2x(x - 2)}{x - 2} = 2x.',
  },
  {
    id: 2,
    prompt: 'Theo tính chất cơ bản của phân thức, khi nhân cả tử và mẫu với cùng một đa thức M khác 0 ta được:',
    latexExpression: '\\dfrac{A}{B} = \\dfrac{A \\cdot M}{?}',
    options: ['B \\cdot M', 'B + M', 'B - M', 'B'],
    correctIndex: 0,
    solution: 'Tính chất: \\dfrac{A}{B} = \\dfrac{A \\cdot M}{B \\cdot M} với M \\neq 0.',
  },
  {
    id: 3,
    prompt: 'Quy tắc đổi dấu phân thức nào sau đây ĐÚNG?',
    latexExpression: '\\dfrac{A}{B} = ?',
    options: ['\\dfrac{-A}{-B}', '-\\dfrac{A}{B}', '\\dfrac{-A}{B}', '\\dfrac{A}{-B}'],
    correctIndex: 0,
    solution: 'Quy tắc đổi dấu: Đổi dấu cả tử và mẫu của một phân thức thì được một phân thức bằng phân thức đã cho: \\dfrac{A}{B} = \\dfrac{-A}{-B}.',
  },
  {
    id: 4,
    prompt: 'Quy đồng mẫu thức hai phân thức \\dfrac{1}{x - 1} và \\dfrac{2}{x + 1} được mẫu thức chung tối giản là:',
    latexExpression: 'MTC = ?',
    options: ['x^2 - 1', '(x - 1)^2', '(x + 1)^2', 'x - 1'],
    correctIndex: 0,
    solution: 'Mẫu thức chung MTC = (x - 1)(x + 1) = x^2 - 1.',
  },
  {
    id: 5,
    prompt: 'Phân thức nào sau đây là phân thức tối giản?',
    latexExpression: '\\text{Nhận biết phân thức tối giản}',
    options: ['\\dfrac{x + 1}{x^2 + 2}', '\\dfrac{2x - 2}{x - 1}', '\\dfrac{x^2 - 1}{x - 1}', '\\dfrac{3x}{6x^2}'],
    correctIndex: 0,
    solution: '\\dfrac{x + 1}{x^2 + 2} không thể rút gọn thêm (tử và mẫu không có nhân tử chung khác 1 và -1).',
  },
];

export default function TinhChatPhanThucInteractive() {
  ...
  return (
    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', margin: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h4 style={{ margin: 0, color: '#1e293b', fontSize: '1.15rem' }}>🎯 Luyện tập Tính chất cơ bản, Rút gọn & Quy đồng Phân thức</h4>
