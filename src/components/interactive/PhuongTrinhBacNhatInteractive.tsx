...
const PROBLEMS: Problem[] = [
  {
    ...
    latexExpression: '2x - 6 = 0 \\Rightarrow x = ?',
    options: ['x = 3', 'x = -3', 'x = 6', 'x = 0'],
    correctIndex: 0,
    solution: '2x = 6 \\Rightarrow x = 6 / 2 = 3.',
  },
  {
    id: 2,
    prompt: 'Phương trình bậc nhất một ẩn là phương trình có dạng ax + b = 0 với điều kiện gì?',
    latexExpression: 'ax + b = 0 \\quad (a = ?)',
    options: ['a khác 0', 'a = 0', 'b khác 0', 'a và b cùng bằng 0'],
    correctIndex: 0,
    solution: 'Định nghĩa: Phương trình ax + b = 0 với a khác 0 được gọi là phương trình bậc nhất một ẩn.',
  },
  {
    id: 3,
    prompt: 'Nghiệm của phương trình 3x + 5 = 2x - 1 là:',
    latexExpression: '3x - 2x = -1 - 5 \\Rightarrow x = ?',
    options: ['x = -6', 'x = 6', 'x = -4', 'x = 4'],
    correctIndex: 0,
    solution: '3x - 2x = -1 - 5 \\Rightarrow x = -6.',
  },
  {
    id: 4,
    prompt: 'Nghiệm của phương trình \\dfrac{x - 1}{2} + \\dfrac{x + 1}{3} = 2 là:',
    latexExpression: '3(x - 1) + 2(x + 1) = 12 \\Rightarrow x = ?',
    options: ['x = 2.6', 'x = 3', 'x = 2', 'x = 5'],
    correctIndex: 0,
    solution: '3x - 3 + 2x + 2 = 12 \\Rightarrow 5x - 1 = 12 \\Rightarrow 5x = 13 \\Rightarrow x = 2.6.',
  },
  {
    id: 5,
    prompt: 'Phương trình nào sau đây KHÔNG PHẢI là phương trình bậc nhất một ẩn?',
    latexExpression: '\\text{Nhận biết phương trình bậc nhất}',
    options: ['0x + 3 = 0', '2x - 1 = 0', '5 - 3x = 0', '\\dfrac{1}{2}x + 4 = 0'],
    correctIndex: 0,
    solution: '0x + 3 = 0 có a = 0 nên không phải là phương trình bậc nhất một ẩn.',
  },
];

export default function PhuongTrinhBacNhatInteractive() {
  ...
  return (
    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', margin: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h4 style={{ margin: 0, color: '#1e293b', fontSize: '1.15rem' }}>🎯 Luyện tập Phương trình bậc nhất một ẩn</h4>
