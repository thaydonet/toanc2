...
const PROBLEMS: Problem[] = [
  {
    id: 1,
    prompt: 'Viết biểu thức $x^3 + 8$ dưới dạng tích:',
    latexExpression: 'x^3 + 8',
    options: ['(x + 2)(x^2 - 2x + 4)', '(x + 2)(x^2 + 2x + 4)', '(x + 2)^3', '(x - 2)(x^2 + 2x + 4)'],
    correctIndex: 0,
    solution: 'x^3 + 8 = x^3 + 2^3 = (x + 2)(x^2 - 2 \\cdot x + 2^2) = (x + 2)(x^2 - 2x + 4)',
  },
  {
    id: 2,
    prompt: 'Viết biểu thức $27x^3 - 1$ dưới dạng tích:',
    latexExpression: '27x^3 - 1',
    options: ['(3x - 1)(9x^2 + 3x + 1)', '(3x - 1)(9x^2 - 3x + 1)', '(3x - 1)^3', '(3x + 1)(9x^2 - 3x + 1)'],
    correctIndex: 0,
    solution: '27x^3 - 1 = (3x)^3 - 1^3 = (3x - 1)[(3x)^2 + 3x \\cdot 1 + 1^2] = (3x - 1)(9x^2 + 3x + 1)',
  },
  {
    id: 3,
    prompt: 'Rút gọn biểu thức $A = (x + 3)(x^2 - 3x + 9) - x^3$:',
    latexExpression: 'A = (x + 3)(x^2 - 3x + 9) - x^3',
    options: ['27', '9', '0', '-27'],
    correctIndex: 0,
    solution: 'A = (x^3 + 3^3) - x^3 = x^3 + 27 - x^3 = 27',
  },
  {
    id: 4,
    prompt: 'Viết tích $(2x - y)(4x^2 + 2xy + y^2)$ dưới dạng hiệu hai lập phương:',
    latexExpression: '(2x - y)(4x^2 + 2xy + y^2)',
    options: ['8x^3 - y^3', '4x^3 - y^3', '2x^3 - y^3', '8x^3 + y^3'],
    correctIndex: 0,
    solution: '(2x - y)[(2x)^2 + 2x \\cdot y + y^2] = (2x)^3 - y^3 = 8x^3 - y^3',
  },
  {
    id: 5,
    prompt: 'Tính giá trị biểu thức $B = (x - 2)(x^2 + 2x + 4)$ tại $x = 10$:',
    latexExpression: 'B = (x - 2)(x^2 + 2x + 4)',
    options: ['992', '1000', '998', '1008'],
    correctIndex: 0,
    solution: 'B = x^3 - 2^3 = x^3 - 8. Thay x = 10 \\Rightarrow B = 10^3 - 8 = 1000 - 8 = 992',
  },
];

export default function HangDangThuc3Interactive() {
  ...
  return (
    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', margin: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h4 style={{ margin: 0, color: '#1e293b', fontSize: '1.15rem' }}>🎯 Luyện tập Hằng đẳng thức: Tổng & Hiệu hai lập phương</h4>
