...
const PROBLEMS: Problem[] = [
  {
    id: 1,
    prompt: 'Khai triển hằng đẳng thức $(x + 3)^2$:',
    latexExpression: '(x + 3)^2',
    options: ['x^2 + 6x + 9', 'x^2 + 3x + 9', 'x^2 + 6x + 6', 'x^2 + 9'],
    correctIndex: 0,
    solution: '(x + 3)^2 = x^2 + 2 \\cdot x \\cdot 3 + 3^2 = x^2 + 6x + 9',
  },
  {
    id: 2,
    prompt: 'Khai triển hằng đẳng thức $(2x - 1)^2$:',
    latexExpression: '(2x - 1)^2',
    options: ['4x^2 - 4x + 1', '4x^2 - 2x + 1', '2x^2 - 4x + 1', '4x^2 - 1'],
    correctIndex: 0,
    solution: '(2x - 1)^2 = (2x)^2 - 2 \\cdot 2x \\cdot 1 + 1^2 = 4x^2 - 4x + 1',
  },
  {
    id: 3,
    prompt: 'Viết dưới dạng tích: $x^2 - 16$:',
    latexExpression: 'x^2 - 16',
    options: ['(x - 4)(x + 4)', '(x - 16)(x + 16)', '(x - 4)^2', '(x + 4)^2'],
    correctIndex: 0,
    solution: 'x^2 - 16 = x^2 - 4^2 = (x - 4)(x + 4)',
  },
  {
    id: 4,
    prompt: 'Tính nhanh $101^2$ bằng hằng đẳng thức $(a+b)^2$:',
    latexExpression: '101^2',
    options: ['10201', '10101', '10001', '10301'],
    correctIndex: 0,
    solution: '101^2 = (100 + 1)^2 = 100^2 + 2 \\cdot 100 \\cdot 1 + 1^2 = 10000 + 200 + 1 = 10201',
  },
  {
    id: 5,
    prompt: 'Viết biểu thức $x^2 - 4xy + 4y^2$ thành bình phương một hiệu:',
    latexExpression: 'x^2 - 4xy + 4y^2',
    options: ['(x - 2y)^2', '(x + 2y)^2', '(x - y)^2', '(2x - y)^2'],
    correctIndex: 0,
    solution: 'x^2 - 4xy + 4y^2 = x^2 - 2 \\cdot x \\cdot (2y) + (2y)^2 = (x - 2y)^2',
  },
  {
    id: 6,
    prompt: 'Tính nhanh $99^2 - 1$ bằng hiệu hai bình phương:',
    latexExpression: '99^2 - 1^2',
    options: ['9800', '9801', '9799', '9900'],
    correctIndex: 0,
    solution: '99^2 - 1 = (99 - 1)(99 + 1) = 98 \\cdot 100 = 9800',
  },
  {
    id: 7,
    prompt: 'Khai triển $(3x + 2y)^2$:',
    latexExpression: '(3x + 2y)^2',
    options: ['9x^2 + 12xy + 4y^2', '9x^2 + 6xy + 4y^2', '3x^2 + 12xy + 2y^2', '9x^2 + 4y^2'],
    correctIndex: 0,
    solution: '(3x + 2y)^2 = (3x)^2 + 2 \\cdot 3x \\cdot 2y + (2y)^2 = 9x^2 + 12xy + 4y^2',
  },
  {
    id: 8,
    prompt: 'Viết biểu thức $4x^2 - 9y^2$ thành tích:',
    latexExpression: '4x^2 - 9y^2',
    options: ['(2x - 3y)(2x + 3y)', '(4x - 9y)(4x + 9y)', '(2x - 3y)^2', '(2x + 3y)^2'],
    correctIndex: 0,
    solution: '4x^2 - 9y^2 = (2x)^2 - (3y)^2 = (2x - 3y)(2x + 3y)',
  },
];

export default function HangDangThuc1Interactive() {
  ...
  return (
    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', margin: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h4 style={{ margin: 0, color: '#1e293b', fontSize: '1.15rem' }}>🎯 Luyện tập Hằng đẳng thức: Bình phương & Hiệu hai bình phương</h4>
