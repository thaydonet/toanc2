...
export const quizData = [
  ...
  {
    type: "mcq",
    question: "Nếu $!tinh: !b! * !x(2,3,4)!!$ chia hết cho $!b(2,3,4)!$ và $!tinh: !b! * !y(2,3,4)!!$ chia hết cho $!b!$ thì tổng của chúng có chia hết cho $!b!$ không?",
    option_a: "Có",
    option_b: "Không",
    option_c: "Không xác định",
    option_d: "Tùy trường hợp",
    correct_option: "A",
    explanation: "$!tinh: !b! * !x!! + !tinh: !b! * !y!! = !b! \\times (!x! + !y!)$ nên tổng chia hết cho $!b!$.",
    difficulty_level: "medium",
    is_dynamic: true,
  },
];
