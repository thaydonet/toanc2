...
const PROBLEMS: Problem[] = [
  {
    id: 1,
    prompt: 'Nghiệm của phương trình 4x - 12 = 0 là:',
    latexExpression: '4x - 12 = 0 \\Rightarrow x = ?',
  ...
  {
    id: 2,
    prompt: 'Cho hàm số y = 3x - 2. Giá trị của y khi x = 2 là:',
    latexExpression: 'y = 3(2) - 2 = ?',
    options: ['4', '6', '2', '0'],
    correctIndex: 0,
    solution: 'y = 3(2) - 2 = 6 - 2 = 4.',
  },
  {
    id: 3,
    prompt: 'Đường thẳng y = ax + 3 đi qua điểm A(1; 5). Giá trị của a bằng:',
    latexExpression: '5 = a(1) + 3 \\Rightarrow a = ?',
    options: ['2', '-2', '3', '5'],
    correctIndex: 0,
    solution: '5 = a + 3 \\Rightarrow a = 2.',
  },
  {
    id: 4,
    prompt: 'Hai đường thẳng y = (m - 1)x + 2 và y = 3x - 1 song song với nhau khi:',
    latexExpression: 'm - 1 = 3 \\Rightarrow m = ?',
    options: ['m = 4', 'm = 3', 'm = 2', 'm = -4'],
    correctIndex: 0,
    solution: 'Hai đường thẳng song song khi hệ số góc bằng nhau: m - 1 = 3 \\Rightarrow m = 4.',
  },
  {
    id: 5,
    prompt: 'Một xe tải đi từ A đến B với vận tốc 45 km/h mất x giờ. Nếu đi với vận tốc 60 km/h thì thời gian giảm 1 giờ. Phương trình lập được là:',
    latexExpression: '45x = 60(x - 1) \\Rightarrow x = ?',
    options: ['x = 4 \\text{ giờ}', 'x = 3 \\text{ giờ}', 'x = 5 \\text{ giờ}', 'x = 2 \\text{ giờ}'],
    correctIndex: 0,
    solution: '45x = 60x - 60 \\Rightarrow 15x = 60 \\Rightarrow x = 4 \\text{ giờ}.',
  },
];

export default function OnTapChuong7Interactive() {
  ...
  return (
    <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', margin: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        <h4 style={{ margin: 0, color: '#1e293b', fontSize: '1.15rem' }}>🎯 Thử thách tổng hợp Ôn tập Chương 7: Phương trình & Hàm số bậc nhất</h4>
